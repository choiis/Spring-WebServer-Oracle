...
<body>
	...
	$(document).ready(function() {
		...
		fn_PreSave = function() {
			...
			if(gfn_isNull($("#ptype").val())) {
				alert("상품유형을 입력하세요");
				return false;
			}
			
			if(gfn_isNull($("input[name=explainfile]")[0].files[0])) {
				alert("설명 파일을 입력해 주세요");
				return false;
			}
		...
		<div id="container_demo">
			<div id="wrapper">
				<div id="sp01insert" class="animate form">
					...
					<form id="form" method="post" enctype="multipart/form-data" action="/common/sp01insert.do">
						...
						<input id="fileInput" type="file" name="explainfile" />
					</form>
				</div>
			</div>
		</div>
