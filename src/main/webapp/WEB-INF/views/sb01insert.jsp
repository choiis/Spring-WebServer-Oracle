...
<body>
	...
	$(document).ready(function() {
		...
		fn_PreSave = function() {
			...
			if(gfn_isNull($("input[name=videoFile]")[0].files[0])) {
				alert("동영상을 입력해 주세요");
				return false;
			}
		...
		<div id="container_demo">
			<div id="wrapper">
				<div id="sb01insert" class="animate form">
					...
					<form id="form" method="post" enctype="multipart/form-data" action="/common/sb01insert.do">
						제목:<input type="text" id="title" name="title"> <br>
						내용<textarea id="text" name="text" rows="10" cols="40"></textarea>
						<button id="btn_insert_button" type="button" >저장</button>
						<input id="fileInput" type="file" name="videoFile" />
					</form>
				</div>
			</div>
		</div>
