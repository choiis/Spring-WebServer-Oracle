...
<body>
	...
	function findSV01() {
		...
		gfn_ajax("sv01showFind.do","POST" , sendData , function(data) {
			var html = "";
	...
	function showSV01List(nowPage) {
		console.log("showSV01List");
		...
		gfn_ajax("sv01show.do","POST" , sendData , function(data) {

			var html = "";
			$.each(data.list, function(index, item) {
				html += '<tr>';
	            html += '<td scope="col" width="50">' + item.seq + '</td>';
	            html += '<td scope="col" width="50"><a href="/common/sv01show_detail.do?seq='+
	            item.seq +'&hit=' +
	            item.hit +'">' + 
 ...
 <jsp:include page="banner.jsp" /> 
	...
	<button id="btn_findText_button" type="button" >게시물 검색</button>
		...
		<div id="pagenation">
			...
			<form id="write_form" action="/common/sv01write.do" method="get">
