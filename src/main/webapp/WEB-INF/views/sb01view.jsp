...
<body>
	...
	function findSB01() {
		...
		gfn_ajaxRest("sb01/find/" + $("#likeSelect").val() + "/" + $("#findText").val(), "GET" , function(data) {
			var html = "";
			
			$.each(data.list, function(index, item) {
				html += '<tr>';
	            html += '<td scope="col" width="50">' + item.seq + '</td>';
	            html += '<td scope="col" width="50"><a href="/sb01/show_detail/'+
	            item.seq +'">' + 
	            item.title + '</a></td>';
 ...
 <jsp:include page="banner.jsp" /> 
	...
	<button id="btn_findText_button" type="button" >게시물 검색</button>
		...
		<div id="pagenation">
			...
			<form id="write_form" action="/sb01/insertPage" method="get">
