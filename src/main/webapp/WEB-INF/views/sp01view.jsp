	...
	function findSP01() {
		...
		gfn_ajax("sp01showFind.do","POST" , sendData , function(data) {
			...
			$.each(data.list, function(index, item) {
	            ...
	            html += '<td scope="col" width="50"><a href="/sp01show_detail/'+
	            item.seq +'">' + 
	            item.title + '</a></td>';
	            ...
	            html += '<td scope="col" width="30">' + gfn_getCommCodeNm(state_code , item.state) + '</td>';
