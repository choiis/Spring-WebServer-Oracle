...
public class SF01Controller extends BaseController {
    ...
    public ResponseEntity<SF01Response> deleteSF01Vo(@PathVariable int seq)
        throws Exception {
        log.debug("enter sf01 delete");

        sf01Service.deleteSF01Vo(seq);
    ...
    public ResponseEntity<SF01Response> likeSF01Vo(@PathVariable int seq, HttpServletRequest request)
        throws Exception {
    ...
    public ResponseEntity<SF01Response> hateSF01Vo(@PathVariable int seq, HttpServletRequest request)
        throws Exception {
