...
public class SV01Controller extends BaseController {
	...
	@ResponseBody
	@RequestMapping(value = "/one/{seq}/{recall}", method = RequestMethod.GET)
	...
	public ResponseEntity<SV01Response> deleteSV01Vo(@PathVariable int seq, HttpServletRequest request)
			throws Exception {
	...
	public ResponseEntity<SV01Response> likeSV01vo(@PathVariable int seq, HttpServletRequest request) throws Exception {
	...
	public ResponseEntity<SV01Response> hateSV01vo(@PathVariable int seq, HttpServletRequest request) throws Exception {
