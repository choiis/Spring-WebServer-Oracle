...
public class SB02Service {
    ...
    public SB02Response insertSB02Vo(SB02Request request, String userid) throws Exception {
        ...
        SB02Vo sb02Vo = SB02Composer.requestToEntity(request, userid);
    ...
    public SB02ListResponse selectSB02Vo(int seq01,
        int parents, int nowPage, String userid) throws Exception {
        SB02Vo sb02Vo = SB02Composer.selectInfoToEntity(seq01, parents, nowPage);
    ...
    public int deleteSB02Vo(int seq,
        int seq01, int parents) throws Exception {

        SB02Vo sb02Vo = SB02Composer.deleteInfoToEntity(seq, seq01, parents);
        if (sb02Vo.getParents() > 0) {
